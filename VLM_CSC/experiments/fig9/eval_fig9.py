...
用法：
    python eval_fig9.py                                # 默认配置
    python eval_fig9.py --max_per_class 50             # 快速验证（5× 加速）
    python eval_fig9.py --sd_steps 10                  # 减少 DDIM 步数（3× 加速）
    python eval_fig9.py --sd_steps 10 --max_per_class 50  # 叠加（≈15× 加速）
